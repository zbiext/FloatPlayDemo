...
public class RenderThread extends Thread {
    ...
    private int compileShader(){
        ...
        String vertexShaderCode = readRawTextFile(mContext, R.raw.vertex);
        String fragmentShaderCode;

        fragmentShaderCode = readRawTextFile(mContext, R.raw.no_effect);
    ...
    private void startPreview(){
        ...
        ((BaseActivity)mContext).starVideo(textures[0]);
        mTexName = textures[0];
    }
    ...
    public synchronized void run() {
        ...
        while(true) {
            ...
            synchronized(mContext){
                ((BaseActivity)mContext).updateFrame();
